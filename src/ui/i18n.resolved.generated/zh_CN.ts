...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "战场地形",
      "fieldBody": "一片有围墙的露天战场,被隔成三个区域:两队各自的前场,以及夹在中间的废墟中庭。两道横贯全场的隔墙划出边界,穿行区域之间必须经过争夺点:宽阔的正门、紧贴远侧城墙的窄拱门,或是骑跨在隔墙上的门楼小屋,其错位的两扇门逼你绕过伏击死角。门楼设在后门一侧,从要塞窄小后门溜出的旗手可以顺势钻进门楼;每座要塞正门前还有一道矮壁垒挡住直冲的路线。中庭里有空心的中央废墟与两枚侧翼疾行符文,另外两枚守在两旗的接近路上。",
      "flagsHeading": "旗帜",
      ...
      "respawnHeading": "战场阵亡",
      "respawnBody": "死亡保留经典仪式:释放灵魂后,它会在你方主堡的围栏墓地中升起,并被结界束缚,直到你方下一波复活潮(停留过久的尸体会在短暂宽限后自动释放)。每波复活潮会同时唤起所有等待的灵魂,并在行动前获得短暂保护;两队的复活潮刻意错开,战斗永远不会同时完全重置。这里没有跑尸,也没有灵魂医者的交易:复活潮是唯一的归途。",
      "carrierHeading": "扛旗",
