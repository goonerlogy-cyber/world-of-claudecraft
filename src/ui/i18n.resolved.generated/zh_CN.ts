...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "flagsHeading": "旗帜",
      "flagsBody": "每座要塞守着本队军旗。夺取敌旗并送到己方旗座即可得分;先夺得五次者获胜,超时的战斗按比分定胜负。旗手阵亡时旗帜就地掉落:敌人可以再次拾起,而本队队员只需靠近便能立即将其送回。",
      "pickupNote": "拾旗永远需要主动按下战场动作键:没有人会因为跑过旗帜而意外成为旗手。",
      "respawnHeading": "战场阵亡",
      "respawnBody": "鸦裂谷没有跑坟。每队共享一个复活波次,所有阵亡队友随本队波次在要塞一同复活,并在行动前获得短暂保护。两队波次刻意错开,战局永远不会同时清零。",
      "carrierHeading": "扛旗",
