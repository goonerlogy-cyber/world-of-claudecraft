...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "전장",
      "fieldBody": "성벽으로 둘러싸인 야외 전장 양 끝에 요새가 있습니다. 각 요새는 삼면이 막힌 구조로 출구가 둘입니다. 중앙 엄폐물로 향하는 정문과, 옆 성벽에 뚫린 빠른 측면으로 이어지는 좁은 뒷문입니다. 중앙은 무너진 유적으로, 엇갈린 벽과 기둥, 상자가 시야를 끊고, 4개의 질주 룬이 깃발 진입로와 양 측면에 놓여 있습니다.",
      "flagsHeading": "깃발",
