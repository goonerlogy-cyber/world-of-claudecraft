...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "전장",
      "fieldBody": "성벽으로 둘러싸인 야외 전장이 세 구역으로 나뉩니다. 양 팀 각자의 앞마당과 그 사이에 낀 폐허 안뜰입니다. 전장을 가로지르는 두 장벽이 경계를 이루며, 구역 사이를 오가려면 반드시 쟁탈 지점을 지나야 합니다. 넓은 정문, 먼 쪽 성벽에 붙은 좁은 아치, 그리고 장벽에 걸쳐 앉은 문루입니다. 문루의 두 문은 엇갈리게 나 있어 매복 모퉁이를 돌아가야 합니다. 문루는 뒷문 쪽에 있어 요새의 좁은 뒷문으로 빠져나온 기수가 곧장 숨어들 수 있고, 각 요새 정문 앞에는 낮은 방책이 서서 일직선 돌격을 막습니다. 안뜰에는 속이 빈 중앙 유적과 측면의 질주 룬 2개가 있으며, 나머지 2개는 깃발 진입로에 놓여 있습니다.또한 각 정문의 안뜰 입구에는 전투 룬 또는 수호 룬(짧은 시간 동안 피해 증가 또는 피해 감소)이 기다립니다. 두 받침대는 같은 면으로 경기를 시작하며 차지할 때마다 면이 뒤집힙니다.",
      "flagsHeading": "깃발",
      ...
      "respawnBody": "죽음은 고전 의식을 그대로 따릅니다. 영혼을 해방하면 아군 요새 옆 울타리 묘지에서 영혼이 일어나, 다음 아군 부활 파도까지 그곳에 결박됩니다(오래 방치된 시신은 짧은 유예 후 자동으로 해방됩니다). 각 파도는 기다리던 모든 영혼을 함께 일으키며, 행동하기 전까지 잠시 보호됩니다. 두 팀의 파도는 의도적으로 엇갈려 있어 전투가 한꺼번에 완전히 초기화되는 일은 없습니다. 시신 달리기도, 영혼 치유사와의 거래도 없습니다. 파도만이 유일한 귀환길입니다.",
