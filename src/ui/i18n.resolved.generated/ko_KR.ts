...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "전장",
      "fieldBody": "성벽으로 둘러싸인 야외 전장 양 끝에 요새가 있습니다. 각 요새는 삼면이 막힌 구조로 출구가 둘입니다. 정문 앞에는 낮은 방책이 서서 일직선 돌격을 막고, 옆 성벽에는 빠른 측면으로 이어지는 좁은 뒷문이 뚫려 있습니다. 양쪽 측면 성벽에는 앞뒤로 문이 난 쪽방과 얕은 엄폐 벽감이 마련되어, 벽을 따라 달리는 길이 매복 모퉁이를 갖춘 진짜 경로가 됩니다. 중앙은 무너진 유적으로, 엇갈린 벽과 기둥, 상자, 흩어진 잔해 벽 조각이 속이 빈 중앙 유적 둘레에 여러 갈래 길을 엮고, 4개의 질주 룬이 깃발 진입로와 양 측면에 놓여 있습니다.",
      "flagsHeading": "깃발",
      "flagsBody": "각 요새는 자기 팀의 깃발을 지킵니다. 적 깃발을 빼앗아 아군 깃대까지 가져오면 득점하며, 먼저 5회 탈취한 팀이 승리하고 시간이 다 된 전투는 점수로 판가름납니다. 운반자가 쓰러지면 깃발은 그 자리에 떨어집니다. 적은 다시 주울 수 있지만, 깃발 주인 팀은 가까이 가기만 해도 즉시 되찾아옵니다.",
      "pickupNote": "깃발 줍기는 언제나 전장 행동 키를 의도적으로 누르는 행위입니다. 깃발 위를 스쳐 지나갔다고 운반자가 되는 일은 없습니다.",
      "respawnHeading": "전장에서의 죽음",
      "respawnBody": "레이븐리프트에는 무덤 달리기가 없습니다. 각 팀은 공용 부활 웨이브를 가지며, 쓰러진 팀원 전원이 팀 웨이브에 맞춰 요새에서 함께 살아나고 행동하기 전까지 잠시 보호받습니다. 두 팀의 웨이브는 의도적으로 엇갈려 있어 전선이 한꺼번에 초기화되지 않습니다.",
