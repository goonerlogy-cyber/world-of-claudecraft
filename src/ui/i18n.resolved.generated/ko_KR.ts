...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      ...
      "levelRequirement": "레벨 {level} 이상 참가 가능합니다.",
      "board": {
        "kills": "처치",
        "deaths": "죽음",
        "captures": "탈취"
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "respawnBody": "죽음은 고전 의식을 그대로 따릅니다. 영혼을 해방하면 아군 요새의 울타리 묘지에서 영혼이 일어나, 다음 아군 부활 파도까지 그곳에 결박됩니다(오래 방치된 시신은 짧은 유예 후 자동으로 해방됩니다). 각 파도는 기다리던 모든 영혼을 함께 일으키며, 행동하기 전까지 잠시 보호됩니다. 두 팀의 파도는 의도적으로 엇갈려 있어 전투가 한꺼번에 완전히 초기화되는 일은 없습니다. 시신 달리기도, 영혼 치유사와의 거래도 없습니다. 파도만이 유일한 귀환길입니다.",
