...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "Поле",
      "fieldBody": "Обнесенное стенами открытое поле с крепостью на каждом конце. Каждая крепость закрыта с трех сторон и имеет два выхода: главные ворота к укрытиям середины поля и узкую калитку в боковой стене, выводящую на быстрый фланг. В центре разрушенные руины: смещенные стены, колонны и ящики режут линии обзора, а четыре руны спринта ждут на подходах к флагам и на двух флангах.",
      "flagsHeading": "Флаги",
