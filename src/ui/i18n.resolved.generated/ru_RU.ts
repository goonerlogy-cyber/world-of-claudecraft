...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "keybinds": {
      ...
      "battleground": "Вороний Разлом (поле боя)",
    ...
    "bg": {
      "title": "Вороний Разлом",
      "modeTag": "Захват флага 5 на 5",
      "close": "Закрыть",
      "offlineNote": "Вороний Разлом синхронизируется. Очередь откроется после ответа мира.",
      ...
      "searching": "Поиск. В очереди {count}/10.",
      "queuedParty": "Группа из {count}.",
      "queueNote": "Две команды по пять бойцов. Украдите вражеское знамя и принесите его в свою крепость. Побеждает команда, первой захватившая флаг 5 раз. Собирайте группу до 5 человек и вставайте в очередь вместе; подбирайте руны спринта и уходите от погони между укрытиями.",
      ...
      "protectedFor": "Защита возрождения: {seconds} с",
      "foundBanner": "Битва найдена. Вы сражаетесь за {team}!",
      "countdownBanner": "Вороний Разлом начнется через {seconds}",
      ...
      "defeatBanner": "Поражение. Вороний Разлом {crimson}:{azure}. Рейтинг {rating} ({delta})",
      "drawBanner": "Ничья в Вороньем Разломе {crimson}:{azure}. Рейтинг {rating} ({delta})",
      "endLog": "Вороний Разлом завершен, {crimson}:{azure}. Рейтинг {rating} ({delta}).",
      "mobileLabel": "Разлом"
    },
    "vcup": {
      "title": "Кубок Долины",
  ...
  "guide": {
    ...
    "ravenriftPage": {
      "heading": "Вороний Разлом",
      "intro": "Рейтинговое поле боя 5 на 5 в режиме захвата флага: две команды по пять бойцов, две крепости, одна цель. Украдите вражеское знамя и принесите его домой раньше, чем унесут ваше.",
      "queueHeading": "Очередь",
      "queueBody": "Откройте панель Вороньего Разлома и встаньте в очередь в одиночку или соберите группу до пяти человек и вставайте вместе: группа всегда попадает в одну команду, а свободные места заполняют одиночные бойцы. Когда готовы десять, матч рассаживает обе команды по крепостям для короткого построения, после чего флаги оживают.",
      "fieldHeading": "Поле",
      "fieldBody": "Обнесенное стенами открытое поле с крепостью на каждом конце. Каждая крепость закрыта с трех сторон и имеет два выхода: главные ворота, где низкая баррикада ломает прямой натиск, и узкую калитку в боковой стене, выводящую на быстрый фланг. Вдоль каждой фланговой стены устроена карманная комната с дверями с обеих сторон и неглубокие ниши-укрытия, так что пробежка вдоль стены становится настоящим маршрутом с углами для засад. В центре разрушенные руины: смещенные стены, колонны, ящики и обломки стен сплетают несколько разных троп вокруг полого сердца руин, а четыре руны спринта ждут на подходах к флагам и на двух флангах.",
      "flagsHeading": "Флаги",
      ...
      "respawnBody": "В Вороньем Разломе нет пробежки с кладбища. У каждой команды общая волна возрождения: все павшие бойцы поднимаются вместе на волне своей команды в крепости и ненадолго защищены, пока не начнут действовать. Волны двух команд намеренно смещены, так что бой никогда не обнуляется целиком.",
