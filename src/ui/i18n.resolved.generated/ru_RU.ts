...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "pvp": {
      "launcherTitle": "PvP: Вороний Разлом и арены",
      "mobileLabel": "PvP",
      "bracket1v1": "1v1",
      "bracket2v2": "2v2"
    },
    "bg": {
      ...
      "levelRequirement": "Требуется уровень {level}.",
      "board": {
        "kills": "Убийства",
        "deaths": "Смерти",
        "captures": "Захваты"
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "Поле",
      "fieldBody": "Обнесенное стенами открытое поле разделено на три зоны: собственное поле каждой команды и Двор Руин между ними. Две куртины во всю ширину образуют границы, и любой переход между зонами идет через спорную точку: широкие главные ворота, узкую арку у дальней стены или надвратный дом, оседлавший куртину, чьи смещенные двери заставляют огибать угол засады. Надвратный дом стоит со стороны калитки, так что знаменосец, выскользнувший через узкую калитку крепости, ныряет прямо в него, а низкая баррикада у ворот каждой крепости ломает прямой натиск. Во дворе ждут полое сердце руин и две фланговые руны спринта; еще две стоят на подходах к флагам.",
      "flagsHeading": "Флаги",
      ...
      "respawnBody": "Смерть хранит классический обряд: отпустите дух, и он поднимется на огороженном кладбище вашей крепости, связанный оберегом до следующей волны возрождения вашей команды (залежавшееся тело отпустят за вас после короткой отсрочки). Каждая волна поднимает всех ожидающих духов разом, с краткой защитой до первого действия; волны двух команд нарочно смещены, так что бой никогда не обнуляется целиком. Здесь нет бега за телом и сделки с Целителем душ: волна - единственная дорога назад.",
