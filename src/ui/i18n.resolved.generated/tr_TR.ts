...
export const tr_TR: EnTranslations = {
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "respawnBody": "There is no graveyard run in Ravenrift. Each team has a shared respawn wave, and every fallen teammate rises together on their team wave at the keep, briefly protected until they act. The two team waves are deliberately staggered, so the fight never fully resets at once.",
