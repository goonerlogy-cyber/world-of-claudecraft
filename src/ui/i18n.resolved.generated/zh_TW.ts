...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      ...
      "levelRequirement": "需要等級{level}。",
      "board": {
        "kills": "擊殺",
        "deaths": "死亡",
        "captures": "奪旗"
      },
      "flagTakenBanner": "{name}奪走了{team}的旗幟!",
      "flagReturnedBanner": "{team}的旗幟已歸還!",
      "capturedBanner": "{name}奪取了{team}的旗幟!{crimson}:{azure}",
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "fieldHeading": "戰場地形",
      "fieldBody": "一片有圍牆的露天戰場,被隔成三個區域:兩隊各自的前場,以及夾在中間的廢墟中庭。兩道橫貫全場的隔牆劃出邊界,穿行區域之間必須經過爭奪點:寬闊的正門、緊貼遠側城牆的窄拱門,或是騎跨在隔牆上的門樓小屋,其錯位的兩扇門逼你繞過伏擊死角。門樓設在後門一側,從要塞窄小後門溜出的旗手可以順勢鑽進門樓;每座要塞正門前還有一道矮壁壘擋住直衝的路線。中庭裡有空心的中央廢墟與兩枚側翼疾行符文,另外兩枚守在兩旗的接近路上。",
      "flagsHeading": "旗幟",
      ...
      "respawnHeading": "戰場陣亡",
      "respawnBody": "死亡保留經典儀式:釋放靈魂後,它會在你方主堡的圍欄墓地中升起,並被結界束縛,直到你方下一波復活潮(停留過久的屍體會在短暫寬限後自動釋放)。每波復活潮會同時喚起所有等待的靈魂,並在行動前獲得短暫保護;兩隊的復活潮刻意錯開,戰鬥永遠不會同時完全重置。這裡沒有跑屍,也沒有靈魂醫者的交易:復活潮是唯一的歸途。",
      "carrierHeading": "扛旗",
