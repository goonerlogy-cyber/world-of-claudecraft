...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      ...
      "levelRequirement": "レベル{level}が必要です。",
      "board": {
        "kills": "キル",
        "deaths": "デス",
        "captures": "奪取"
  ...
  "guide": {
    ...
    "ravenriftPage": {
      ...
      "respawnBody": "死は古典の儀式のまま:魂を解放すると、自陣キープの柵に囲まれた墓地に霊体として現れ、次のチーム復活ウェーブまでそこに縛られます(放置された遺体も短い猶予の後に自動で解放されます)。ウェーブは待機中の霊体を全員同時に蘇らせ、行動するまで短時間保護されます。両チームのウェーブは意図的にずらされており、戦いが同時に完全リセットされることはありません。遺体走りも、スピリットヒーラーとの取引もありません:ウェーブこそが唯一の帰り道です。",
      "carrierHeading": "旗の運搬",
