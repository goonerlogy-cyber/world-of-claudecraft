...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bg.searching': '匹配中。队列 {count}/10。',
  ...
  'guide.ravenriftPage.fieldBody':
    '一片有围墙的露天战场,被隔成三个区域:两队各自的前场,以及夹在中间的废墟中庭。两道横贯全场的隔墙划出边界,穿行区域之间必须经过争夺点:宽阔的正门、紧贴远侧城墙的窄拱门,或是骑跨在隔墙上的门楼小屋,其错位的两扇门逼你绕过伏击死角。门楼设在后门一侧,从要塞窄小后门溜出的旗手可以顺势钻进门楼;每座要塞正门前还有一道矮壁垒挡住直冲的路线。中庭里有空心的中央废墟与两枚侧翼疾行符文,另外两枚守在两旗的接近路上。',
  'guide.ravenriftPage.flagsHeading': '旗帜',
  'guide.ravenriftPage.flagsBody':
    '每座要塞守着本队军旗。夺取敌旗并送到己方旗座即可得分;先夺得五次者获胜,超时的战斗按比分定胜负。旗手阵亡时旗帜就地掉落:敌人可以再次拾起,而本队队员只需靠近便能立即将其送回。',
