...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.ravenriftPage.fieldBody':
    '一片有围墙的露天战场,两端各有一座要塞。每座要塞是三面围合的工事,有两条出路:正门前一道矮壁垒挡住直冲的路线,另有一侧城墙上通往快速侧翼的窄小后门。两侧城墙下各有一间前后开门的侧室,墙边还留有浅浅的掩体壁龛,让沿墙奔跑成为一条有掩护、有伏击角落的真正路线。中央是断壁残垣:错落的矮墙、石柱、木箱与散落的残墙碎段,在空心的中央废墟四周织出数条不同的小径,四枚疾行符文分布在旗帜要道与两翼。',
