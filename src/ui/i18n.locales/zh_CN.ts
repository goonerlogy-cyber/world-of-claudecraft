...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.ravenriftPage.fieldBody':
    '一片有围墙的露天战场,被隔成三个区域:两队各自的前场,以及夹在中间的废墟中庭。两道横贯全场的隔墙划出边界,穿行区域之间必须经过争夺点:宽阔的正门、紧贴远侧城墙的窄拱门,或是骑跨在隔墙上的门楼小屋,其错位的两扇门逼你绕过伏击死角。门楼设在后门一侧,从要塞窄小后门溜出的旗手可以顺势钻进门楼;每座要塞正门前还有一道矮壁垒挡住直冲的路线。中庭里有空心的中央废墟与两枚侧翼疾行符文,另外两枚守在两旗的接近路上。每个正门的中庭入口处还有一枚战斗或守护符文(短时间内提升伤害或减免伤害):两个符文台开局同面,每次拾取后翻面。',
