...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bg.searching': 'マッチング中。キュー {count}/10。',
  ...
  'guide.ravenriftPage.intro':
    'ランク制5v5キャプチャー・ザ・フラッグの戦場。5人ずつの2チーム、2つの砦、目標はひとつ。敵の軍旗を奪い、奪われる前に持ち帰れ。',
  ...
  'guide.ravenriftPage.fieldBody':
    '壁に囲まれた野外の戦場は、3つの区画に分かれています。両チームそれぞれの前庭と、その間に挟まれた「廃墟の中庭」です。全幅を貫く2枚の隔壁が境界となり、区画間の移動は必ず争奪点を通ります。広い正門、遠い側の城壁沿いの狭いアーチ、そして隔壁をまたぐ門楼です。門楼の2つの扉は互い違いに開いており、伏撃の角を回り込む必要があります。門楼は抜け道側に置かれているため、砦の狭い抜け道から抜け出した旗手はそのまま門楼へ滑り込めます。各砦の正面口には低いバリケードが立ち、まっすぐな突撃を阻みます。中庭には空洞の中心遺跡と側翼の2つのスプリントルーンがあり、残る2つは旗への進路に待っています。',
  'guide.ravenriftPage.flagsHeading': '旗',
  'guide.ravenriftPage.flagsBody':
    '各砦は自軍の旗を守っています。敵の旗を奪って自軍の旗座まで運べば得点。先に5回キャプチャーしたチームの勝利で、時間切れの戦いはスコアで決着します。倒された運び手はその場に旗を落とします。敵は拾い直せますが、旗の持ち主チームは近づくだけで即座に旗を戻せます。',
