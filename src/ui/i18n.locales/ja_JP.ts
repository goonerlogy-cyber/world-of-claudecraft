...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.unitFrameHealthText': 'ユニットフレームの体力表示',
  'hudChrome.options.unitFrameDamageTrail': '遅延ダメージ表示',
  'hudChrome.options.unitFramePortraitEffects': 'ポートレートの反応',
  ...
  'guide.ravenriftPage.fieldBody':
    '壁に囲まれた野外の戦場は、3つの区画に分かれています。両チームそれぞれの前庭と、その間に挟まれた「廃墟の中庭」です。全幅を貫く2枚の隔壁が境界となり、区画間の移動は必ず争奪点を通ります。広い正門、遠い側の城壁沿いの狭いアーチ、そして隔壁をまたぐ門楼です。門楼の2つの扉は互い違いに開いており、伏撃の角を回り込む必要があります。門楼は抜け道側に置かれているため、砦の狭い抜け道から抜け出した旗手はそのまま門楼へ滑り込めます。各砦の正面口には低いバリケードが立ち、まっすぐな突撃を阻みます。中庭には空洞の中心遺跡と側翼の2つのスプリントルーンがあり、残る2つは旗への進路に待っています。さらに各正門の中庭側入口にはバトルルーンまたはウォードルーン(短時間、与ダメージ増加か被ダメージ軽減)が待機:両方の台は同じ面で試合を開始し、取得のたびに面が切り替わります。',
  ...
  'hudChrome.unitFrame.targetOfTargetNamedLabel': 'ターゲットのターゲット：{name}',
  'hudChrome.unitFrame.auraOverflowShort': '+{count}',
  'hudChrome.unitFrame.auraOverflowLabel': '追加のバフ {count} 件',
