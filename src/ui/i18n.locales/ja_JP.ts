...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.ravenriftPage.fieldBody':
    '壁に囲まれた野外の戦場で、両端に砦があります。各砦は三方を囲まれた構えで、出口は2つ。正面口には低いバリケードが立ってまっすぐな突撃を阻み、側面の壁には速い側翼へ抜ける狭い抜け道が開いています。両翼の城壁沿いには前後2つの出入口を持つ小部屋と浅い遮蔽の窪みが設けられ、壁沿いの走路は伏撃の角を備えた本物のルートになっています。中央は崩れた遺跡で、互い違いの壁や柱、木箱、崩れ残った壁の断片が、空洞の中心遺跡の周りに幾筋もの道を織り、4つのスプリントルーンが旗への進路と両翼に待っています。',
