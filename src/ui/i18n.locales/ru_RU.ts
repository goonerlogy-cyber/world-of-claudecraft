...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.unitFrameHealthText': 'Текст здоровья рамки',
  'hudChrome.options.unitFrameDamageTrail': 'Отложенный след урона',
  'hudChrome.options.unitFramePortraitEffects': 'Реакции портрета',
  ...
  'hudChrome.unitFrame.targetOfTargetNamedLabel': 'Цель цели: {name}',
  'hudChrome.unitFrame.auraOverflowShort': '+{count}',
  'hudChrome.unitFrame.auraOverflowLabel': 'Дополнительных усилений: {count}',
