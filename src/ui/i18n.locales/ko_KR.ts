...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.ravenriftPage.fieldBody':
    '성벽으로 둘러싸인 야외 전장이 세 구역으로 나뉩니다. 양 팀 각자의 앞마당과 그 사이에 낀 폐허 안뜰입니다. 전장을 가로지르는 두 장벽이 경계를 이루며, 구역 사이를 오가려면 반드시 쟁탈 지점을 지나야 합니다. 넓은 정문, 먼 쪽 성벽에 붙은 좁은 아치, 그리고 장벽에 걸쳐 앉은 문루입니다. 문루의 두 문은 엇갈리게 나 있어 매복 모퉁이를 돌아가야 합니다. 문루는 뒷문 쪽에 있어 요새의 좁은 뒷문으로 빠져나온 기수가 곧장 숨어들 수 있고, 각 요새 정문 앞에는 낮은 방책이 서서 일직선 돌격을 막습니다. 안뜰에는 속이 빈 중앙 유적과 측면의 질주 룬 2개가 있으며, 나머지 2개는 깃발 진입로에 놓여 있습니다.',
